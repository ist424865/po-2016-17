...
public class UninitializedIdentifiersVisitor implements ExpressionVisitor {

    private TreeSet<String> _identifiers = new TreeSet<String>();
    private TreeSet<String> _initialized = new TreeSet<String>();
